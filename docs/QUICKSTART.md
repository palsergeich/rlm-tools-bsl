...
Промпт: "Зарегистрируй через rlm-tools-bsl каталог D:/Repos/erp/src/cf как проект ERP (описание - это ERP 2.5), покажи весь список зарегистрированных проектов"

```
rlm_projects(action="add", name="ERP", path="D:/Repos/erp/src/cf", description="ERP 2.5")
...
rlm_index(action="update", project="ERP")
```
...
6. Зарегистрируйте проект (в чате Kilo):
   > Зарегистрируй через rlm-tools-bsl проект ERP с путём D:/Repos/erp/src/cf
