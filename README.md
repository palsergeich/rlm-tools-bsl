...
- `find_custom_modifications(object_name, custom_prefixes=['лтх',...])` — найти все нетиповые доработки в модулях объекта: процедуры с нетиповым префиксом, регионы `#Область ИРИС`, нетиповые реквизиты в XML
